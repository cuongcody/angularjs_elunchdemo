(function () {
    ...
    CommentsController.$inject = ['CommentsService', 'MenuService' , '$rootScope', '$routeParams', '$filter', 'FlashService'];
    function CommentsController(CommentsService, MenuService, $rootScope, $routeParams, $filter, FlashService) {
        var vm = this;
        vm.comments = [];
        vm.dishes = [];
        vm.replies = [];
