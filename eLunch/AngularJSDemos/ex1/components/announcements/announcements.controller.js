(function () {
    ...
    AnnouncementsController.$inject = ['AnnouncementsService', 'MenuService' , '$rootScope', '$routeParams', '$filter', 'FlashService'];
    function AnnouncementsController(AnnouncementsService, MenuService, $rootScope, $routeParams, $filter, FlashService) {
        var vm = this;
        vm.announcements = [];
        vm.dishes = [];
        vm.replies = [];
